      ...
      <div className={style.containerContent}>
        ...
        <div className={style.profiles}>
          ...
          <div className={style.profile2}>
            ...
            <div className="mx-auto w-40 h-40 relative -mt-16 border-2 border-white rounded-full overflow-hidden bg-white">
              <img
                className="object-cover object-center h-40"
                src="./src/assets/bannerme.png"
                alt="Men looking front"
              />
            </div>
            <div className="text-center mt-2">
              <h2 className="font-semibold text-white text-3xl relative bottom-2">
                Tomas Pon
              </h2>
              <p className="text-gray-500  text-2xl">Desarollador Full-Stack</p>
            </div>
            <div className="p-3 border-t mx-6 mt-2 border-white relative top-4">
